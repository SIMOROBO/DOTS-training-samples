...
{
    public static ParticleDrawCall GetComputeDrawcall(ComputeShader shader, Mesh instanceMesh, Material material, uint count, ComputeParticleManager.SimulationParams simulationParams)
    {
        if (shader == null)
        {
            return null;
